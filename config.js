...
module.exports = {
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? '  ࿑𝐌𝐀𝐆𝐈𝐂𝐈𝐀𝐍❥࿑⁩  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '917994206751' : process.env.YAK,
    ...
    BOTV2: process.env.BOTV2_NAME === undefined ? '❀ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝𝙍𝘼𝙃𝙀𝙀𝙎࿐' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '❀ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝𝙍𝘼𝙃𝙀𝙀𝙎࿐' : process.env.LOGO_NAME,
